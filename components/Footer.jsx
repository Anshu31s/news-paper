import { BsFacebook, BsTwitter, BsRss, BsInstagram, BsLinkedin, BsVimeo, BsCalendar, BsNewspaper, BsTelephone, BsEnvelope, BsClock, BsGeoAlt } from "react-icons/bs";

const Footer = ({ topNews }) => {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            ...
            <div>
              ...
              {topNews.slice(1, 4).map((item, index) => (
                <div
                  key={index}
                  className={`flex gap-3 ${index !== 0 && "border-t mt-3 pt-3"} text-white/50`}
                >
                  <div className="w-1/3 relative h-[100px] overflow-hidden rounded">
                    <img
                      src={item.image_url || "https://via.placeholder.com/150x100?text=No+Image"}
                      alt={item.title}
                      className="w-full rounded"
                    />
                    <span className="absolute top-0 left-0 text-white text-[10px] px-2 py-1 rounded bg-orange-500">
            ...
            <div className="flex flex-col">
              <div>
                <b className="text-white text-lg block mb-4">About News Times</b>
                ...
                <p className="mt-3 text-sm text-white/50">
                  Aliquam erat volutpat. Proin rhoncus est ac ipsum varius fermentum...
                </p>
                <ul className="text-white/50 mt-4 text-sm space-y-3">
                  <li>
                    <a href="#" className="flex items-center">
                      <BsTelephone className="text-orange-500 mr-2" /> Office: +123 4567 890
                    </a>
                  </li>
                  <li>
                    <a href="#" className="flex items-center">
                      <BsEnvelope className="text-orange-500 mr-2" /> info@gmail.com
                    </a>
                  </li>
                  <li>
                    <a href="#" className="flex items-center">
                      <BsClock className="text-orange-500 mr-2" /> Opening Hours: 10:00 - 18:00
                    </a>
                  </li>
                  <li>
                    <a href="#" className="flex items-center">
                      <BsGeoAlt className="text-orange-500 mr-2" /> 36 Nora Dreek, India
                    </a>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-10">
                <div className="border border-gray-700 p-3">
                  ...
                  <ul className="flex flex-wrap gap-3 text-white/50 text-2xl mt-3">
                    <li><a href="#"><BsFacebook /></a></li>
                    <li><a href="#"><BsTwitter /></a></li>
                    <li><a href="#"><BsRss /></a></li>
          ...
          <div className="flex flex-col md:flex-row justify-between text-sm text-white/50">
            <div>
              <p className="mb-0">
                ...
                <a className="text-orange-500 font-bold" href="http://www.theanshu.tech">
                  Anshus Sharma
                </a>
              </p>
            </div>
              ...
              <ul className="flex flex-wrap items-center gap-2 justify-end text-xs uppercase">
                {["Facebook", "Twitter", "Pinterest", "Instagram"].map((item, i) => (
                  <li key={i} className="flex items-center">
                    <a className="text-white/50 hover:text-white" href="#">{item}</a>
